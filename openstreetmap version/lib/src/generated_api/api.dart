...
part 'model/combined_report_item.dart';
...
part 'model/notification_message.dart';
part 'model/notification_type.dart';
part 'model/order.dart';
part 'model/permission.dart';
part 'model/position.dart';
part 'model/post_commands_send202_response.dart';
part 'model/queued_command.dart';
part 'model/report_geofences.dart';
