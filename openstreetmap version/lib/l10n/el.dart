const Map<String, String> el = {
  ...
  "sharedSaved": "Αποθηκεύτηκε",
  "sharedUpload": "Ανέβασμα",
  "sharedSet": "Καθορισμός",
  "sharedAccept": "Αποδοχή",
  "sharedCancel": "Άκυρο",
  "sharedCopy": "Αντιγραφή",
  "sharedAdd": "Προσθήκη",
  "sharedEdit": "Επεξεργασία",
  "sharedRemove": "Κατάργηση",
  "sharedRemoveConfirm": "Κατάργηση στοιχείου;",
  ...
  "sharedAttributes": "Xαρακτηριστικά",
  ...
  "sharedComputedAttributes": "Υπολογισμένα Xαρακτηριστικά",
  ...
  "sharedDeviceAccumulators": "Αθροιστές",
  ...
  "attributeWebReportColor": "Ιστός: Χρώμα Αναφοράς",
  ...
  "attributeProcessingCopyAttributes": "Επεξεργασία: Αντιγραφή Χαρακτηριστικών",
  "attributeColor": "Χρώμα",
  "attributeWebLiveRouteLength": "Ιστός: Μήκος Ζωντανής Διαδρομής",
  "attributeMapLineWidth": "Πλάτος Γραμμής Χάρτη",
  "attributeMapLineOpacity": "Διαφάνεια Γραμμής Χάρτη",
  "attributeWebSelectZoom": "Ιστός: Επιλογή Μεγέθυνσης",
  "attributeWebMaxZoom": "Ιστός: Μέγιστη Μεγέθυνση",
  ...
  "attributeMailSmtpHost": "Email: Κεντρικός υπολογιστής SMTP",
  "attributeMailSmtpPort": "Email: Θύρα SMTP",
  "attributeMailSmtpStarttlsEnable": "Email: Ενεργοποίηση SMTP STARTTLS",
  "attributeMailSmtpStarttlsRequired": "Email: Απαιτείται SMTP STARTTLS",
  "attributeMailSmtpSslEnable": "Email: Ενεργοποίηση SSL SMTP",
  "attributeMailSmtpSslTrust": "Email: Εμπιστοσύνη SSL SMTP",
  "attributeMailSmtpSslProtocols": "Email: Πρωτόκολλα SSL του SMTP",
  "attributeMailSmtpFrom": "Email: Αποστολέας SMTP",
  "attributeMailSmtpAuth": "Email: Ενεργοποίηση Ελέγχου Ταυτότητας SMTP",
  "attributeMailSmtpUsername": "Email: Όνομα χρήστη SMTP",
  "attributeMailSmtpPassword": "Email: Κωδικός πρόσβασης SMTP",
  "attributeNavigationAppLink": "Σύνδεσμος εφαρμογής πλοήγησης",
  "attributeNavigationAppTitle": "Τίτλος εφαρμογής πλοήγησης",
  "attributeUiDisableSavedCommands": "Διεπαφή: Απενεργοποίηση Αποθηκευμένων Εντολών",
  "attributeUiDisableAttributes": "Διεπαφή: Απενεργοποίηση Xαρακτηριστικών",
  ...
  "attributeUiDisableComputedAttributes": "Διεπαφή: Απενεργοποίηση Υπολογισμένων Χαρακτηριστικών",
  ...
  "attributeUiHidePositionAttributes": "Διεπαφή: Απόκρυψη Χαρακτηριστικών Θέσης",
  ...
  "attributeForwardUrl": "Προώθηση URL",
  "errorTitle": "Σφάλμα",
  ...
  "userToken": "Διακριτικό πρόσβασης",
  "userDeleteAccount": "Διαγραφή λογαριασμού",
  "userTemporary": "Προσωρινό",
  "userTerms": "Όροι Χρήσης",
  "userPrivacy": "Πολιτική Ιδιωτικότητας",
  "userTermsPrompt": "Πατώντας Αποδοχή, αποδέχεστε τους Όρους Παροχής Υπηρεσιών μας και επιβεβαιώνετε ότι έχετε διαβάσει την Πολιτική Απορρήτου μας",
  ...
  "deviceCommandSender": "Κανάλι Εντολών",
  ...
  "positionRpm": "ΣΑΛ",
  "positionFuel": "Καύσιμα",
  "positionFuelUsed": "Καύσιμο που χρησιμοποιήθηκε",
  "positionPower": "Τάση",
  "positionBattery": "Μπαταρία",
  ...
  "mapOverlay": "Επικάλυψη Χάρτη",
  "mapOverlayCustom": "Προσαρμοσμένη Επικάλυψη",
  ...
  "mapOpenWeatherPrecipitation": "OpenWeather Κατακρημνίσεις",
  "mapOpenWeatherPressure": "OpenWeather Πίεση",
  "mapOpenWeatherWind": "OpenWeather Άνεμος",
  "mapOpenWeatherTemperature": "OpenWeather Θερμοκρασία",
  "mapLayer": "Στρώμα Χάρτη",
  ...
  "mapGoogleTraffic": "Google Οδικός",
  "mapGoogleKey": "Google Κλειδί API",
  ...
  "mapYandexSat": "Yandex Δορυφορικός",
  "mapWikimedia": "Wikimedia",
  "mapOrdnanceSurvey": "Ordnance Survey",
  "mapMapboxStreets": "Mapbox Οδικός",
  "mapMapboxStreetsDark": "Mapbox Οδικός Σκοτεινός",
  "mapMapboxOutdoors": "Mapbox Υπαίθριος",
  "mapMapboxSatellite": "Mapbox Δορυφορικός",
  "mapMapboxKey": "Mapbox Διακριτικό Πρόσβασης",
  "mapMapTilerBasic": "MapTiler Βασικός",
  "mapMapTilerHybrid": "MapTiler Υβριδικός",
  "mapMapTilerKey": "MapTiler Κλειδί API",
  "mapOpenFreeMap": "OpenFreeMap",
  "mapLocationIqStreets": "LocationIQ Οδικός",
  "mapLocationIqDark": "LocationIQ Σκοτεινός",
  "mapLocationIqKey": "LocationIQ Διακριτικό Πρόσβασης",
  "mapTomTomBasic": "TomTom Βασικός",
  "mapTomTomFlow": "TomTom Ροή Κυκλοφορίας",
  "mapTomTomIncidents": "TomTom Συμβάντα Κυκλοφορίας",
  "mapTomTomKey": "TomTom Κλειδί API",
  "mapHereBasic": "Here βασικός",
  "mapHereHybrid": "Here Υβριδικός",
  "mapHereSatellite": "Here Δορυφορικός",
  "mapHereFlow": "Here Ροή Κυκλοφορίας",
  "mapHereKey": "Here Κλειδί API",
  ...
  "mapPoiLayer": "Στρώμα Σημείων Ενδιαφέροντος",
  ...
  "commandSetAgps": "Καθορισμός AGPS",
  "commandSetIndicator": "Καθορισμός Δείκτη",
  "commandConfiguration": "Διαμόρφωση",
  "commandGetVersion": "Λήψη Έκδοσης",
  "commandFirmwareUpdate": "Ενημέρωση λογισμικού",
  "commandSetConnection": "Καθορισμός Σύνδεσης",
  "commandSetOdometer": "Καθορισμός Οδομέτρου",
  "commandGetModemStatus": "Λήψη Κατάσταση Αποδιαμορφωτή",
  "commandGetDeviceStatus": "Λήψη Κατάστασης Συσκευής",
  "commandSetSpeedLimit": "Καθορισμός Ορίου Ταχύτητας",
  "commandModePowerSaving": "Λειτουργία εξοικονόμησης ενέργειας",
  "commandModeDeepSleep": "Λειτουργία βαθύ ύπνου",
  "commandAlarmGeofence": "Καθορισμός Συναγερμού Γεωφράγματος",
  "commandAlarmBattery": "Καθορισμός Συναγερμού Μπαταρίας",
  "commandAlarmSos": "Καθορισμός συναγερμού SOS",
  "commandAlarmRemove": "Καθορισμός κατάργησης συναγερμού",
  "commandAlarmClock": "Καθορισμός ξυπνητηριού",
  "commandAlarmSpeed": "Καθορισμός Συναγερμού Ταχύτητας",
  "commandAlarmFall": "Καθορισμός Συναγερμού Πτώσης",
  "commandAlarmVibration": "Καθορισμός Συναγερμού Κραδασμών",
  ...
  "eventQueuedCommandSent": "Εντολή στην ουρά στάλθηκε",
  "eventDeviceMoving": "Συσκευή σε Κίνηση",
  "eventDeviceStopped": "Συσκευή σε Στάση",
  "eventDeviceOverspeed": "Υπέρβαση ορίου ταχύτητας",
  "eventDeviceFuelDrop": "Πτώση καυσίμων",
  "eventDeviceFuelIncrease": "Αύξηση καυσίμων",
  ...
  "alarmPowerCut": "Απώλεια Τροφοδοσίας",
  "alarmPowerRestored": "Αποκατάσταση Τροφοδοσίας",
  "alarmJamming": "Παρεμβολές",
  "alarmTemperature": "Θερμοκρασία",
  "alarmParking": "Στάθμευση",
  "alarmBonnet": "Καπό",
  "alarmFootBrake": "Ποδόφρενο",
  "alarmFuelLeak": "Διαρροή καυσίμων",
  ...
  "notificatorWeb": "Ιστός",
  "notificatorMail": "Ηλεκτρονικό ταχυδρομείο",
  "notificatorSms": "SMS",
  "notificatorFirebase": "Ειδοποίηση Push",
  "notificatorTraccar": "Ειδοποίηση Push",
  "notificatorTelegram": "Telegram",
  "notificatorPushover": "Pushover",
  "reportReplay": "Επανάληψη",
  "reportCombined": "Συνδυασμένες",
  ...
  "reportStartEngineHours": "Έναρξη Ωρών Μηχανής",
  "reportEndEngineHours": "Λήξη Ωρών Μηχανής",
  ...
  "statisticsMessagesReceived": "Εισερχόμενα Μηνύματα",
  ...
  "dashboardHello": "Γεια σας",
  "dashboardWelcomeBack": "Καλώς ήρθατε πίσω, εδώ είναι η επισκόπηση σας.",
  ...
  "deviceOffline": "Συσκευή εκτός σύνδεσης",
  "deviceMoving": "Συσκευή σε κίνηση",
  "deviceStopped": "Συσκευή σταμάτησε",
  "geofenceEnter": "Είσοδος σε γεωφράκτης",
  "geofenceExit": "Έξοδος από γεωφράκτης",
  "alarm": "Συναγερμός",
  "unknownEvent": "Άγνωστο γεγονός",
  "settingsFontSize": "Μέγεθος Γραμματοσειράς",
  "settingsMarkerSize": "Μέγεθος Σήμανσης",
  "settingsNormal": "Κανονικό",
  "settingsLarge": "Μεγάλο",
  "settingsExtraLarge": "Πολύ Μεγάλο",
  "reportGeofences": "Αναφορά γεωφράχτη",
