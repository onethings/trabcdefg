const Map<String, String> mk = {
    ...
    "settingsTheme": "Режим на тема",
    "themeSystem": "Системски стандардно",
    "themeLight": "Светол режим",
    "themeDark": "Темен режим",
    "appVersion": "Верзија",
    "loginLanguage": "Јазик",
    "sharedOn": "ВКЛУЧЕНО",
    "sharedOff": "ИСКЛУЧЕНО",
    "sharedLocating": "Лоцирање...",
    "deviceStatusAccOn": "ACC ВКЛУЧЕНО",
    "deviceStatusOfflineUpper": "ОФЛАЈН",
    "dashboardTitle": "Контролна табла",
    "notificationsTitle": "Известувања",
    "dashboardHello": "Здраво",
    "dashboardWelcomeBack": "Добредојдовте назад, еве го вашиот преглед.",
    ...
    "deviceOffline": "Уредот е офлајн",
    "deviceMoving": "Уредот се движи",
    "deviceStopped": "Уредот е сопрен",
    "geofenceEnter": "Влегување во гео-зона",
    "geofenceExit": "Излегување од гео-зона",
    "alarm": "Аларм",
    "unknownEvent": "Непознат настан",
    "settingsFontSize": "Големина на фонт",
    "settingsMarkerSize": "Големина на маркер",
    "settingsNormal": "Нормална",
    "settingsLarge": "Голема",
    "settingsExtraLarge": "Екстра голема"
};