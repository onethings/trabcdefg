const Map<String, String> az ={
    ...
    "settingsTheme": "Mövzu Rejimi",
    "themeSystem": "Sistem Defoltu",
    "themeLight": "Açıq Rejim",
    "themeDark": "Tünd Rejim",
    "appVersion": "Versiya",
    "loginLanguage": "Dil",
    "sharedOn": "AÇIQ",
    "sharedOff": "QAPALI",
    "sharedLocating": "Axtarılır...",
    "deviceStatusAccOn": "ACC AÇIQ",
    "deviceStatusOfflineUpper": "OFFLAYN",
    "dashboardTitle": "İdarə Paneli",
    "notificationsTitle": "Bildirişlər",
    "dashboardHello": "Salam",
    "dashboardWelcomeBack": "Yenidən xoş gəldiniz. Budur cari statusun icmalı.",
    ...
    "deviceOffline": "Cihaz Offlayndır",
    "deviceMoving": "Cihaz Hərəkət Edir",
    "deviceStopped": "Cihaz Dayandı",
    "geofenceEnter": "Geozonaya daxil oldu",
    "geofenceExit": "Geozonadan çıxdı",
    "alarm": "Həyəcan",
    "unknownEvent": "Naməlum Hadisə",
    "settingsFontSize": "Şrift Ölçüsü",
    "settingsMarkerSize": "Marker Ölçüsü",
    "settingsNormal": "Normal",
    "settingsLarge": "Böyük",
    "settingsExtraLarge": "Çox Böyük"
};