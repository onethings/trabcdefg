const Map<String, String> fa = {
  ...
  "sharedHide": "مخفی",
  "sharedSave": "ذخيره",
  "sharedSaved": "ذخیره شد",
  "sharedUpload": "بارگذاری",
  "sharedSet": "تنظیم",
  "sharedAccept": "پذیرفتن",
  "sharedCancel": "انصراف",
  "sharedCopy": "کپی",
  ...
  "deviceShare": "اشتراک گذاری دستگاه",
  "groupDialog": "گروه",
  "groupParent": "گروه",
  ...
  "settingsDarkMode": "حالت تیره",
  "settingsTotpEnable": "فعالسازی رمز عبور یکبار مصرف",
  "settingsTotpForce": "اجبار رمز عبور یکبار مصرف",
  "settingsServiceWorkerUpdateInterval": "ServiceWorker Update Interval",
  "settingsUpdateAvailable": "به روز رسانی موجود است",
  ...
  "mapGoogleTraffic": "نقشه ترافیک گوگل",
  "mapGoogleKey": "کلید API گوگل",
  ...
  "commandAlarmVibration": "تنظیم هسدار ضربه",
  ...
  "eventQueuedCommandSent": "دستورات در صف",
  ...
  "reportStartEngineHours": "شروع زمان روشن بودن موتور",
  "reportEndEngineHours": "اتمام زمان روشن بودن موتور",
  ...
  "sharedOn": "روشن",
  "sharedOff": "خاموش",
  "sharedLocating": "در حال مکان‌یابی...",
  "deviceStatusAccOn": "ACC روشن",
  "deviceStatusOfflineUpper": "آفلاین",
  "dashboardTitle": "داشبورد",
  "notificationsTitle": "اعلان‌ها",
  "dashboardHello": "سلام",
  "dashboardWelcomeBack": "خوش آمدید، این خلاصه‌ای از وضعیت فعلی است.",
  ...
  "deviceOffline": "دستگاه آفلاین است",
  "deviceMoving": "دستگاه در حال حرکت است",
  "deviceStopped": "دستگاه متوقف شده است",
  "geofenceEnter": "ورود به محدوده جغرافیایی",
  "geofenceExit": "خروج از محدوده جغرافیایی",
  "alarm": "هشدار",
  "unknownEvent": "رویداد ناشناخته",
  "settingsFontSize": "اندازه قلم",
  "settingsMarkerSize": "اندازه نشانگر",
  "settingsNormal": "عادی",
  "settingsLarge": "بزرگ",
  "settingsExtraLarge": "خیلی بزرگ",
  "reportGeofences": "گزارش حصار جغرافیایی",
