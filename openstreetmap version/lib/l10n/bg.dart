const Map<String, String> bg = {
    ...
    "settingsTheme": "Тема",
    "themeSystem": "Системна по подразбиране",
    ...
    "sharedOn": "ВКЛ.",
    "sharedOff": "ИЗКЛ.",
    "sharedLocating": "Локализиране...",
    "deviceStatusAccOn": "ACC ВКЛ.",
    "deviceStatusOfflineUpper": "ОФЛАЙН",
    "dashboardTitle": "Табло",
    "notificationsTitle": "Известия",
    "dashboardHello": "Здравейте",
    "dashboardWelcomeBack": "Добре дошли отново. Ето преглед на текущото състояние.",
    ...
    "deviceOffline": "Устройството е офлайн",
    "deviceMoving": "Устройството се движи",
    "deviceStopped": "Устройството е спряло",
    "geofenceEnter": "Влизане в геозона",
    "geofenceExit": "Излизане от геозона",
    "alarm": "Аларма",
    "unknownEvent": "Неизвестно събитие",
    "settingsFontSize": "Размер на шрифта",
    "settingsMarkerSize": "Размер на маркера",
    "settingsNormal": "Нормален",
    "settingsLarge": "Голям",
    "settingsExtraLarge": "Много голям"
};