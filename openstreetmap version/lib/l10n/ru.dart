const Map<String, String> ru = {
    ...
    "sharedExtra": "Дополнительные",
    "sharedPrimary": "Основной",
    ...
    "sharedInfoTitle": "Информация о сервисе",
    ...
    "sharedColumns": "Выбор колонок",
    "sharedLogs": "Журналы",
    "sharedLink": "Ссылка",
    "sharedEmulator": "Эмуляция",
    ...
    "attributeMapLineWidth": "Ширина линии карты",
    "attributeMapLineOpacity": "Прозрачность линии",
    ...
    "attributeUiDisableSavedCommands": "UI: Отключить сохраненные команды",
    ...
    "attributeUiDisableVehicleFeatures": "UI: Отключить функции автомобиля",
    ...
    "attributeForwardUrl": "URL переадресации",
    "errorTitle": "Ошибка",
    ...
    "userDeviceLimit": "Лимит устройств",
    ...
    "userTemporary": "Временный",
    "userTerms": "Условия обслуживания",
    "userPrivacy": "Политика конфиденциальности",
    "userTermsPrompt": "Нажимая «Принять», Вы подтверждаете, что ознакомились и соглашаетесь с нашими Условиями обслуживания и Политикой конфиденциальности.",
    ...
    "deviceStatusUnknown": "Неизвестно",
    ...
    "settingsServer": "Настройки сервера",
    ...
    "settingsTotpEnable": "Включить одноразовый пароль",
    "settingsTotpForce": "Принудительный одноразовый пароль",
    "settingsServiceWorkerUpdateInterval": "Интервал обновления ServiceWorker",
    "settingsUpdateAvailable": "Доступно обновление!",
    "settingsSupport": "Техподдержка",
    "reportTitle": "Отчеты",
    ...
    "positionFuelUsed": "Расход топлива",
    ...
    "positionSteps": "Шаги",
    "positionInput": "Входы",
    "positionHeartRate": "Частота сердечных сокращений",
    ...
    "serverColorPrimary": "Web:Основной цвет",
    "serverColorSecondary": "Web:Вторичный цвет",
    "serverLogo": "Логотип",
    "serverLogoInverted": "Инвертированный Логотип",
    "serverChangeDisable": "Отключить смену сервера",
    "serverDisableShare": "Отключить общий доступ к устройству",
    ...
    "mapOpenWeatherClouds": "OpenWeather облачность",
    "mapOpenWeatherPrecipitation": "OpenWeather осадки",
    ...
    "mapGoogleTraffic": "Google Пробки",
    "mapGoogleKey": "Google API ключ",
    ...
    "mapMapboxStreetsDark": "Mapbox Улицы Темный",
    ...
    "mapLocationIqDark": "LocationIQ Темный",
    ...
    "mapHereBasic": "Here Простое",
    "mapHereHybrid": "Here Гибрид",
    "mapHereSatellite": "Here Спутники",
    "mapHereFlow": "Here Пробки",
    "mapHereKey": "Here API ключ",
    "mapShapePolygon": "Многоугольник",
    "mapShapeCircle": "Круг",
    "mapShapePolyline": "Линия",
    "mapLiveRoutes": " Живые маршруты",
    "mapDirection": "Показать направление движения",
    "mapCurrentLocation": "Текущая позиция",
    ...
    "eventQueuedCommandSent": "Поставленная в очередь команда отправлена",
    ...
    "reportStartEngineHours": "Время запуска двигателя",
    "reportEndEngineHours": "Время остановки двигателя",
    ...
    "sharedOn": "ВКЛ",
    "sharedOff": "ВЫКЛ",
    "sharedLocating": "Определение местоположения...",
    "deviceStatusAccOn": "Зажигание ВКЛ",
    "deviceStatusOfflineUpper": "ОФЛАЙН",
    "dashboardTitle": "Панель",
    "notificationsTitle": "Уведомления",
    "dashboardHello": "Здравствуйте",
    "dashboardWelcomeBack": "С возвращением, вот ваш обзор.",
    ...
    "deviceMoving": "Устройство движется",
    "deviceStopped": "Устройство остановлено",
    "geofenceEnter": "Вход в геозону",
    "geofenceExit": "Выход из геозоны",
    "alarm": "Тревога",
    "unknownEvent": "Неизвестное событие",
    "settingsFontSize": "Размер шрифта",
    "settingsMarkerSize": "Размер маркера",
    "settingsNormal": "Обычный",
    "settingsLarge": "Большой",
    "settingsExtraLarge": "Очень большой"
};