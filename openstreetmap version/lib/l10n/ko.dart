const Map<String, String> ko = {
    ...
    "notificatorMail": "이메일",
    "notificatorSms": "메시지",
    "notificatorFirebase": "푸시 알림",
    "notificatorTraccar": "푸시 알림",
    "notificatorTelegram": "텔레그램",
    "notificatorPushover": "푸시 알림",
    "reportReplay": "리플레이",
    "reportCombined": "혼합",
    "reportPositions": "위치",
    "reportEvents": "이벤트",
 ...
 "settingsTheme": "테마 모드",
    ...
    "sharedOn": "켜짐",
    "sharedOff": "꺼짐",
    "sharedLocating": "위치 확인 중...",
    "deviceStatusAccOn": "ACC 켜짐",
    "deviceStatusOfflineUpper": "오프라인",
    "dashboardTitle": "대시보드",
    "notificationsTitle": "알림",
    "dashboardHello": "안녕하세요",
    "dashboardWelcomeBack": "다시 오신 것을 환영합니다. 현재 상황입니다.",
    "dashboardOnline": "온라인",
    ...
    "deviceMoving": "기기 이동 중",
    "deviceStopped": "기기 정지",
    "geofenceEnter": "지오펜스 진입",
    "geofenceExit": "지오펜스 이탈",
    "alarm": "알림",
    "unknownEvent": "알 수 없는 이벤트",
    "settingsFontSize": "글자 크기",
    "settingsMarkerSize": "마커 크기",
    "settingsNormal": "보통",
    "settingsLarge": "큰",
    "settingsExtraLarge": "아주 큰",
};