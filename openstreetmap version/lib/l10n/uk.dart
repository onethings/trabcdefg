const Map<String, String> uk = {
  ...
  "dashboardWelcomeBack": "З поверненням, ось ваш огляд.",
  ...
  "deviceOffline": "Пристрій поза мережею",
  "deviceMoving": "Пристрій рухається",
  "deviceStopped": "Пристрій зупинено",
  "geofenceEnter": "Вхід у геозону",
  "geofenceExit": "Вихід з геозони",
  "alarm": "Тривога",
  "unknownEvent": "Невідома подія",
  "settingsFontSize": "Розмір шрифту",
  "settingsMarkerSize": "Розмір маркера",
  "settingsNormal": "Звичайний",
  "settingsLarge": "Великий",
  "settingsExtraLarge": "Дуже великий",
  "reportGeoFence": "Геозона",
  "reportLogs": "Журнал",
