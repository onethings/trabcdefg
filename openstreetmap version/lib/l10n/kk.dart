const Map<String, String> kk = {
  ...
  "settingsTheme": "Тақырып режимі",
  "themeSystem": "Жүйелік параметр",
  "themeLight": "Ашық режим",
  "themeDark": "Қараңғы режим",
  "appVersion": "Нұсқасы",
  "loginLanguage": "Тіл",
  "sharedOn": "ҚОСУЛЫ",
  "sharedOff": "ӨШІРУЛІ",
  "sharedLocating": "Орналасқан жерді анықтау...",
  "deviceStatusAccOn": "ACC ҚОСУЛЫ",
  "deviceStatusOfflineUpper": "ОФЛАЙН",
  "dashboardTitle": "Басқару панелі",
  "notificationsTitle": "Хабарландырулар",
  "dashboardHello": "Сәлем",
  "dashboardWelcomeBack": "Қайта қош келдіңіз, міне сіздің шолуыңыз.",
  ...
  "deviceOffline": "Құрылғы желіден тыс",
  "deviceMoving": "Құрылғы қозғалуда",
  "deviceStopped": "Құрылғы тоқтатылды",
  "geofenceEnter": "Геозонаға кірді",
  "geofenceExit": "Геозонадан шықты",
  "alarm": "Дабыл",
  "unknownEvent": "Белгісіз оқиға",
  "settingsFontSize": "Қаріп өлшемі",
  "settingsMarkerSize": "Маркер өлшемі",
  "settingsNormal": "Қалыпты",
  "settingsLarge": "Үлкен",
  "settingsExtraLarge": "Өте үлкен",
  "reportGeofences": "Геоқоршау есебі",
