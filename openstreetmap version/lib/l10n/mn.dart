const Map<String, String> mn = {
    ...
    "settingsTheme": "Харагдах байдал",
    "themeSystem": "Системийн тохиргоо",
    "themeLight": "Гэрэлтэй горим",
    "themeDark": "Харанхуй горим",
    "appVersion": "Хувилбар",
    "loginLanguage": "Хэл",
    "sharedOn": "АСААЛТТАЙ",
    "sharedOff": "УНТРААЛТАЙ",
    "sharedLocating": "Байршил тогтоож байна...",
    "deviceStatusAccOn": "ACC АСААЛТТАЙ",
    "deviceStatusOfflineUpper": "ОФЛАЙН",
    "dashboardTitle": "Хянах самбар",
    "notificationsTitle": "Мэдэгдэл",
    "dashboardHello": "Сайн байна уу",
    "dashboardWelcomeBack": "Тавтай морилно уу, таны тойм мэдээлэл энд байна.",
    ...
    "deviceOffline": "Төхөөрөмж офлайн байна",
    "deviceMoving": "Төхөөрөмж хөдөлж байна",
    "deviceStopped": "Төхөөрөмж зогссон",
    "geofenceEnter": "Гео-бүсэд нэвтэрсэн",
    "geofenceExit": "Гео-бүсээс гарсан",
    "alarm": "Дохиолол",
    "unknownEvent": "Үл мэдэгдэх үйл явдал",
    "settingsFontSize": "Үсгийн хэмжээ",
    "settingsMarkerSize": "Тэмдэглэгээний хэмжээ",
    "settingsNormal": "Хэвийн",
    "settingsLarge": "Том",
    "settingsExtraLarge": "Маш том"
};