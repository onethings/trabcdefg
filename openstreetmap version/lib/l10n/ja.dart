const Map<String, String> ja = {
  ...
  "attributeMapLineWidth": "マップの線の太さ",
  "attributeMapLineOpacity": "マップの線の不透明度",
  "attributeWebSelectZoom": "Web: 選択時にズーム",
  "attributeWebMaxZoom": "Web: 最大化",
  "attributeTelegramChatId": "Telegram チャット ID",
  "attributePushoverUserKey": "Pushover ユーザーキー",
  "attributePushoverDeviceNames": "Pushover デバイス名",
  "attributeMailSmtpHost": "メール: SMTP ホスト",
  "attributeMailSmtpPort": "メール: SMTP ポート",
  "attributeMailSmtpStarttlsEnable": "メール: SMTP STARTTLS 有効化",
  "attributeMailSmtpStarttlsRequired": "メール: SMTP STARTTLS 必須",
  "attributeMailSmtpSslEnable": "メール: SMTP SSL 有効化",
  "attributeMailSmtpSslTrust": "メール: SMTP SSL 信頼",
  "attributeMailSmtpSslProtocols": "メール: SMTP SSL プロトコル",
  "attributeMailSmtpFrom": "メール: SMTP 送信元",
  "attributeMailSmtpAuth": "メール: SMTP 認証有効化",
  "attributeMailSmtpUsername": "メール: SMTP ユーザー名",
  "attributeMailSmtpPassword": "メール: SMTP パスワード",
  "attributeNavigationAppLink": "ナビアプリのリンク",
  "attributeNavigationAppTitle": "ナビアプリのタイトル",
  "attributeUiDisableSavedCommands": "UI: 保存されたコマンドを無効化",
  "attributeUiDisableAttributes": "UI: 属性を無効にする",
  "attributeUiDisableGroups": "UI: グループを無効にする",
  "attributeUiDisableEvents": "UI: イベントを無効にする",
  "attributeUiDisableVehicleFeatures": "UI: 車両機能を無効化",
  ...
  "userTemporary": "一時的",
  "userTerms": "利用規約",
  "userPrivacy": "プライバシーポリシー",
  "userTermsPrompt": "「同意する」をクリックすることで、利用規約に同意し、プライバシーポリシーを確認したことになります。",
  "userTermsAccepted": "規約に同意済み",
  "userBilling": "請求情報",
  "loginTitle": "ログイン",
  "loginReset": "パスワードをリセット",
  "loginRegister": "登録",
  "loginLogin": "ログイン",
  "loginOpenId": "OpenID でログイン",
  ...
  "loginLogout": "ログアウト",
  "loginLogo": "ロゴ",
  "loginTotpCode": "ワンタイムパスワードコード",
  "loginTotpKey": "ワンタイムパスワードキー",
  ...
  "settingsTotpEnable": "ワンタイムパスワードを有効化",
  "settingsTotpForce": "ワンタイムパスワードを強制",
  "settingsServiceWorkerUpdateInterval": "ServiceWorker の更新間隔",
  "settingsUpdateAvailable": "アップデートがあります。",
  "settingsSupport": "サポート",
  "reportTitle": "レポート",
  "reportScheduled": "スケジュールされたレポート",
  "reportDevice": "デバイス",
  "reportGroup": "グループ",
  "reportFrom": "開始日時",
  "reportTo": "終了日時",
  ...
  "serverColorPrimary": "プライマリカラー",
  "serverColorSecondary": "セカンダリカラー",
  "serverLogo": "ロゴ画像",
  "serverLogoInverted": "反転ロゴ画像",
  "serverChangeDisable": "サーバー変更を無効化",
  "serverDisableShare": "デバイス共有を無効化",
  "serverReboot": "再起動",
  "mapTitle": "地図",
  "mapActive": "アクティブなマップ",
  ...
  "eventQueuedCommandSent": "キューされたコマンドを送信しました",
  ...
  "notificatorCommand": "コマンド",
  "notificatorWeb": "Web",
  "notificatorMail": "メール",
  "notificatorSms": "SMS",
  "notificatorFirebase": "プッシュ通知",
  "notificatorTraccar": "プッシュ通知",
  "notificatorTelegram": "Telegram",
  "notificatorPushover": "Pushover",
  "reportReplay": "再生",
  "reportCombined": "統合レポート",
  "reportPositions": "位置情報",
  "reportEvents": "イベント",
  "reportTrips": "走行距離",
  "reportStops": "停止",
  "reportSummary": "概要",
  ...
  "reportStartEngineHours": "開始時のエンジン時間",
  "reportEndEngineHours": "終了時のエンジン時間",
  "reportDuration": "期間",
  "reportStartDate": "開始日",
  ...
  "deviceStatusOfflineUpper": "オフライン",
  "dashboardTitle": "ダッシュボード",
  "notificationsTitle": "通知",
  "dashboardHello": "こんにちは",
  "dashboardWelcomeBack": "おかえりなさい。現在の状況です。",
  ...
  "deviceMoving": "デバイス 移動中",
  "deviceStopped": "デバイス 停止中",
  "geofenceEnter": "ジオフェンスへ進入",
  "geofenceExit": "ジオフェンスから離脱",
  "alarm": "アラーム",
  "unknownEvent": "不明なイベント",
  "settingsFontSize": "フォントサイズ",
  "settingsMarkerSize": "マーカーサイズ",
  "settingsNormal": "標準",
  "settingsLarge": "大",
  "settingsExtraLarge": "特大",
  "reportGeofences": "ジオフェンスレポート",
  "reportLogs": "レポートログ",
