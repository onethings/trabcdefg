const Map<String, String> zhCN = {
  ...
  "attributeMapLineWidth": "地图线宽",
  "attributeMapLineOpacity": "地图线透明度",
  ...
  "attributeMailSmtpHost": "电子邮件：SMTP 主机",
  "attributeMailSmtpPort": "电子邮件：SMTP 端口",
  "attributeMailSmtpStarttlsEnable": "电子邮件：启用 SMTP STARTTLS",
  "attributeMailSmtpStarttlsRequired": "电子邮件：需要 SMTP STARTTLS",
  "attributeMailSmtpSslEnable": "电子邮件：启用 SMTP SSL",
  "attributeMailSmtpSslTrust": "电子邮件：信任 SMTP SSL",
  "attributeMailSmtpSslProtocols": "电子邮件：SMTP SSL 协议",
  "attributeMailSmtpFrom": "电子邮件：SMTP 发件人",
  "attributeMailSmtpAuth": "电子邮件：启用 SMTP 身份验证",
  "attributeMailSmtpUsername": "电子邮件：SMTP 用户名",
  "attributeMailSmtpPassword": "电子邮件：SMTP 密码",
  "attributeNavigationAppLink": "导航应用链接",
  "attributeNavigationAppTitle": "导航应用标题",
  ...
  "userTerms": "服务条款",
  "userPrivacy": "隐私政策",
  "userTermsPrompt": "点击“接受”，表示您同意我们的服务条款，并确认您已阅读我们的隐私政策。",
  ...
  "mapOnSelect": "显示地图选项",
  "mapDefault": "默认地图",
  // ── 地图控制列 / 设备切换列（屏幕阅读器用的无障碍标签）──
  "mapLayerToggle": "切换地图图层",
  "mapCompass": "重设地图方向",
  "mapFollowDevice": "跟随设备",
  "mapFitAll": "显示全部设备",
  "mapZoomIn": "放大",
  "mapZoomOut": "缩小",
  "devicePrevious": "上一个设备",
  "deviceNext": "下一个设备",
  "stateTitle": "状态",
  "stateName": "参数",
  "stateValue": "值",
  ...
  "commandRequestPhoto": "请求照片",
  "commandVideoStart": "开启视频",
  "commandVideoStop": "停止视频",
  "commandPowerOff": "关闭设备",
  "commandRebootDevice": "重启设备",
  "commandFactoryReset": "恢复出厂设置",
  "commandSendSms": "发送短信",
  "commandSendUssd": "发送非结构化补充服务数据",
  "commandSosNumber": "设置求救号码",
  ...
  "commandAlarmGeofence": "设置地理围栏警报",
  "commandAlarmBattery": "设置电池警报",
  "commandAlarmSos": "设置求救警报",
  ...
  "notificatorWeb": "网页",
  "notificatorMail": "电子邮件",
  "notificatorSms": "短信",
  "notificatorFirebase": "推送通知",
  "notificatorTraccar": "推送通知",
  ...
  "sharedOff": "关闭",
  "sharedLocating": "定位中...",
  "deviceStatusAccOn": "ACC 开启",
  "deviceStatusOfflineUpper": "离线",
  "dashboardTitle": "仪表板",
  "notificationsTitle": "通知",
  "dashboardHello": "您好",
  "dashboardWelcomeBack": "欢迎回来，这是您的概览。",
  "dashboardOnline": "在线",
  "dashboardMoving": "移动中",
  "dashboardOffline": "离线",
  ...
  "dashboardRecentActivity": "最近动态",
  "dashboardNoEvents": "暂无最近事件。",
  "deviceOnline": "设备上线",
  "deviceOffline": "设备离线",
  "deviceMoving": "设备移动中",
  "deviceStopped": "设备停止",
  "geofenceEnter": "进入电子围栏",
  "geofenceExit": "离开电子围栏",
  "alarm": "警报",
  "unknownEvent": "未知事件",
  "settingsFontSize": "字体大小",
  "settingsMarkerSize": "地图图标大小",
  "settingsNormal": "正常",
  "settingsLarge": "大",
