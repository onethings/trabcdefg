const Map<String, String> zhTw = {
  ...
  "attributeDevicePassword": "裝置密碼",
  "attributeDeviceImage": "裝置圖片",
  "attributeDeviceInactivityStart": "裝置無回應起始",
  "attributeDeviceInactivityPeriod": "裝置無回應期間",
  "attributeProcessingCopyAttributes": "處理中：複製屬性",
  "attributeColor": "顏色",
  "attributeWebLiveRouteLength": "網頁：即時軌跡長度",
  "attributeMapLineWidth": "地圖線寬",
  "attributeMapLineOpacity": "地圖線透明度",
  "attributeWebSelectZoom": "網頁：選擇縮放等級",
  "attributeWebMaxZoom": "網頁∶最大縮放",
  "attributeTelegramChatId": "Telegram 帳號",
  "attributePushoverUserKey": "Pushover 用戶密鑰",
  "attributePushoverDeviceNames": "Pushover 裝置名稱",
  ...
  "attributeUiDisableSavedCommands": "UI：停用已儲存的指令",
  "attributeUiDisableAttributes": "用戶界面：停用屬性",
  "attributeUiDisableGroups": "用戶界面：停用分組",
  "attributeUiDisableEvents": "用戶界面：停用事件",
  "attributeUiDisableVehicleFeatures": "UI：停用車輛功能",
  "attributeUiDisableDrivers": "用戶界面：停用駕駛員",
  "attributeUiDisableComputedAttributes": "用戶界面：停用計算屬性",
  "attributeUiDisableCalendars": "用戶界面：停用日曆",
  "attributeUiDisableMaintenance": "用戶界面：停用保養",
  "attributeUiHidePositionAttributes": "用戶界面：隱藏位置屬性",
  "attributeUiDisableLoginLanguage": "用戶界面：停用登入語言",
  "attributeNotificationTokens": "通知令牌",
  "attributePopupInfo": "資訊卡",
  "attributeForwardUrl": "轉寄 URL",
  "errorTitle": "錯誤",
  ...
  "userTerms": "服務條款",
  "userPrivacy": "隱私權政策",
  "userTermsPrompt": "點擊“接受”，即表示您同意我們的服務條款，並確認您已閱讀我們的隱私權政策。",
  ...
  "loginTotpCode": "一次性密碼",
  "loginTotpKey": "一次性密碼金",
  "devicesAndState": "裝置與狀態",
  "deviceSelected": "已選定的裝置",
  "deviceTitle": "裝置",
  "devicePrimaryInfo": "裝置標題",
  "deviceSecondaryInfo": "裝置詳情",
  ...
  "deviceRegisterFirst": "註冊您的首個裝置",
  "deviceIdentifierHelp": "IMEI、序列號或其他 ID。必須與裝置回報到伺服器的識別碼相同。",
  "deviceShare": "分享裝置",
  "groupDialog": "群組",
  "groupParent": "上層群組",
  "groupNoGroup": "無所屬群組",
  ...
  "settingsTotpEnable": "啟用一次性密碼",
  "settingsTotpForce": "強制一次性密碼",
  "settingsServiceWorkerUpdateInterval": "ServiceWorker 更新間隔",
  ...
  "positionHumidity": "濕度",
  "positionTemp": "溫度",
  "positionDeviceTemp": "裝置溫度",
  "positionCoolantTemp": "水冷液溫度",
  "positionEngineTemp": "引擎溫度",
  "positionOperator": "司機",
  "positionCommand": "命令",
  "positionBlocked": "已封鎖",
  "positionDtcs": "動態扭力控制",
  ...
  "serverDisableShare": "禁用裝置共享",
  "serverReboot": "重啟",
  "mapTitle": "地圖",
  "mapActive": "啟用地圖",
  "mapOverlay": "地圖疊層",
  "mapOverlayCustom": "自定義疊層",
  "mapOpenSeaMap": "OpenSea 地圖",
  "mapOpenRailwayMap": "鐵路地圖",
  "mapOpenWeatherKey": "OpenWeather API 密鑰",
  "mapOpenWeatherClouds": "OpenWeather 雲層圖",
  "mapOpenWeatherPrecipitation": "OpenWeather 降水圖",
  "mapOpenWeatherPressure": "OpenWeather 氣壓圖",
  "mapOpenWeatherWind": "OpenWeather 風力圖",
  "mapOpenWeatherTemperature": "OpenWeather 氣溫圖",
  "mapLayer": "地圖圖層",
  "mapCustom": "自定義(XYZ)",
  "mapCustomArcgis": "自定義(ArcGIS)",
  "mapCustomLabel": "Custom Map",
  "mapCarto": "CARTO 地圖",
  "mapOsm": "OpenStreet 地圖",
  "mapGoogleRoad": "Google 道路地圖",
  "mapGoogleHybrid": "Google 混合地圖",
  "mapGoogleSatellite": "Google 衛星地圖",
  "mapGoogleTraffic": "Google 交通",
  "mapGoogleKey": "Google API 金鑰",
  "mapOpenTopoMap": "OpenTopo 地圖",
  ...
  "mapMapboxStreetsDark": "Mapbox 街道黑暗",
  "mapMapboxOutdoors": "Mapbox 外景",
  "mapMapboxSatellite": "Mapbox 衛星地圖",
  "mapMapboxKey": "Maxbox 訪問令牌",
  "mapMapTilerBasic": "MapTiler 基礎地圖",
  "mapMapTilerHybrid": "MapTiler 混合地圖",
  "mapMapTilerKey": "MapTiler API 密鑰",
  "mapOpenFreeMap": "開放自由地圖",
  "mapLocationIqStreets": "LocationIQ 街道地圖",
  "mapLocationIqDark": "LocationIQ 黑主題",
  "mapLocationIqKey": "LocationIQ 訪問指令牌",
  "mapTomTomBasic": "TomTom 基礎地圖",
  "mapTomTomFlow": "TomTom 交通路況",
  "mapTomTomIncidents": "TomTom 交通事故",
  "mapTomTomKey": "TomTom API密鑰",
  "mapHereBasic": "Here 基礎地圖",
  "mapHereHybrid": "Here 混合地圖",
  "mapHereSatellite": "Here 衛星地圖",
  "mapHereFlow": "Here 交通路况",
  "mapHereKey": "Here API 密鑰",
  "mapShapePolygon": "多邊形",
  "mapShapeCircle": "圓形",
  ...
  "mapPoiLayer": "POI 圖層",
  "mapClustering": "標記叢集",
  "mapOnSelect": "選擇裝置時顯示地圖",
  "mapDefault": "預設地圖",
  // ── 地圖控制列 / 裝置切換列（螢幕閱讀器用的無障礙標籤）──
  "mapLayerToggle": "切換地圖圖層",
  "mapCompass": "重設地圖方向",
  "mapFollowDevice": "跟隨裝置",
  "mapFitAll": "顯示全部裝置",
  "mapZoomIn": "放大",
  "mapZoomOut": "縮小",
  "devicePrevious": "上一個裝置",
  "deviceNext": "下一個裝置",
  "stateTitle": "狀態",
  "stateName": "名稱",
  "stateValue": "數值",
  ...
  "commandUnit": "單位",
  "commandCustom": "自訂命令",
  "commandDeviceIdentification": "裝置識別號碼",
  ...
  "commandVideoStart": "開始視頻",
  "commandVideoStop": "停止視頻",
  "commandPowerOff": "裝置關機",
  "commandRebootDevice": "重啟裝置",
  ...
  "commandSetConnection": "設定連接",
  "commandSetOdometer": "設定里程表",
  "commandGetModemStatus": "獲取數據機狀態",
  "commandGetDeviceStatus": "獲取裝置狀態",
  "commandSetSpeedLimit": "設定速度限制",
  "commandModePowerSaving": "省電模式",
  "commandModeDeepSleep": "睡眠模式",
  "commandAlarmGeofence": "設定地理圍籬警報",
  "commandAlarmBattery": "設定電池警報",
  "commandAlarmSos": "設定 SOS 警報",
  "commandAlarmRemove": "設定刪除警報",
  "commandAlarmClock": "設定時鐘警報",
  "commandAlarmSpeed": "設定速度警報",
  "commandAlarmFall": "設定掉落警報",
  "commandAlarmVibration": "設定震動警報",
  "commandFrequency": "頻率",
  "commandTimezone": "時區",
  "commandMessage": "訊息",
  "commandRadius": "半徑",
  ...
  "eventDeviceInactive": "裝置無回應",
  "eventQueuedCommandSent": "已發送排列命令",
  "eventDeviceMoving": "裝置移動中",
  "eventDeviceStopped": "裝置已停止",
  ...
  "reportDeviceName": "裝置名稱",
  "reportAverageSpeed": "平均速率",
  "reportMaximumSpeed": "最高速率",
  "reportEngineHours": "引擎時數",
  "reportStartEngineHours": "啟動引擎小時數",
  "reportEndEngineHours": "引擎運轉時間結束",
  "reportDuration": "持續時間",
  ...
  "sharedOff": "關閉",
  "sharedLocating": "定位中...",
  "deviceStatusAccOn": "ACC 開啟",
  "deviceStatusOfflineUpper": "離線",
  "dashboardTitle": "儀表板",
  "notificationsTitle": "通知",
  "dashboardHello": "您好",
  "dashboardWelcomeBack": "歡迎回來",
  "dashboardOnline": "上線",
  "dashboardMoving": "移動中",
  "dashboardOffline": "離線",
  ...
  "dashboardRecentActivity": "最近動態",
  "dashboardNoEvents": "沒有最近事件",
  "deviceOnline": "裝置上線",
  "deviceOffline": "裝置離線",
  "deviceMoving": "裝置移動中",
  "deviceStopped": "裝置停止",
