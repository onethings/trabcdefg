...
class CombinedReport {
  ...
  CombinedReport.fromJson(Map<String, dynamic> json) {
    ...
    if (json['events'] != null) {
      events = (json['events'] as List).map((v) => api.Event.fromJson(v)).whereType<api.Event>().toList();
    }
    if (json['positions'] != null) {
      positions = (json['positions'] as List).map((v) => api.Position.fromJson(v)).whereType<api.Position>().toList();
    }
  }
