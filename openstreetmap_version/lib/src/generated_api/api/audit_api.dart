...
class AuditApi {
  ...
  ///   in ISO 8601 format. eg. `1963-11-22T18:30:00Z`
  Future<Response> getAuditWithHttpInfo(
    DateTime from,
    DateTime to,
  ) async {
  ...
  /// * [DateTime] to (required):
  ///   in ISO 8601 format. eg. `1963-11-22T18:30:00Z`
  Future<List<Action>?> getAudit(
    DateTime from,
    DateTime to,
  ) async {
    final response = await getAuditWithHttpInfo(
      from,
      to,
    );
    ...
    if (response.body.isNotEmpty &&
      ...
      return (await apiClient.deserializeAsync(responseBody, 'List<Action>')
              as List)
          .cast<Action>()
